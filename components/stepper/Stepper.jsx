...
export default function Stepper() {
  ...
  const [isOnboardingDicisionClick, setIsOnboardingDicisionClick] =
    useState(false);
        ...
        {isOnboardingDicisionClick && (
          ...
          >
            {currentStep > 0 && (
              ...
              >
                <span className="font-medium text-green-800">Back</span>
              </SubmitButton>
            )}
            ...
            {(currentStep === 0 || (currentStep === 1 && !isEmployee)) && (
              <div>
                <SubmitButton
                  onClick={currentStep === 0 ? goNext : proceedForm}
                  isLoading={isLoading}
